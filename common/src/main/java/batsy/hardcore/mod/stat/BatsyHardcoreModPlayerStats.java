...
public class BatsyHardcoreModPlayerStats {
    public static final Stat<Identifier> BATSY_HARDCORE_TIME_STAT = registerCustomTimeStat(BatsyHardcoreMod.TIME_IN_HARDCORE_STAT, BatsyHardcoreIdentifierProvider.create(BatsyHardcoreMod.TIME_IN_HARDCORE_STAT));
