...
public class BasicReviveParticle extends SpriteBillboardParticle {
    public BasicReviveParticle(ClientWorld clientWorld, double x, double y, double z, SpriteProvider spriteProvider, double dx, double dy, double dz) {
